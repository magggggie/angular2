...
@Component({
  ...
  template:`<h3>Name: <span style="color:green;font-size:18px">
    {{employeeName}}</span></h3>
  <h3>City:<span style="color:green;font-size: 18px">
    {{employeeCity}}</span></h3>
  <h3>Salary:<span style="color:green;font-size: 18px">
    {{employeeSalary}}</span></h3>
    <button (click)="emitSendRecordEvent()">Selector Record</button>
    <hr/>
  `
})
